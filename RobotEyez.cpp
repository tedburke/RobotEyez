...
//
//		cl RobotEyez.cpp ole32.lib strmiids.lib oleaut32.lib
//
...
class FrameProcessor : DexterLib::ISampleGrabberCB
{
private:
	//! COM reference count
	ULONG _ref_count;
...
HRESULT APIENTRY FrameProcessor::BufferCB(double SampleTime, BYTE *pBuffer, long BufferLen)
{
...
HRESULT APIENTRY FrameProcessor::SampleCB(double SampleTime, DexterLib::IMediaSample *pSample)
{
	fprintf(stderr, "s");
	return S_OK;
}
...
int main(int argc, char **argv)
{
	...
	// Set sample grabber callback
	hr = pSampleGrabber->SetCallback((DexterLib::ISampleGrabberCB *)&frameProcessor, 1);
	if (hr != S_OK)
